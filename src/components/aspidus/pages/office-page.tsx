    ...
    return (
      <div className="pt-32 pb-24 page-enter">
        <div className="mx-auto max-w-3xl px-5 sm:px-8 text-center">
          <h1 className="font-serif text-4xl text-[var(--parchment)] mb-4">Office not found</h1>
  ...
  return (
    <div className="page-enter">
      ...
      <section className="relative h-[70vh] min-h-[480px] flex items-end overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#060d18] via-[#060d18]/50 to-[#060d18]/30" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 pb-12 sm:pb-16 w-full">
          <div className="breadcrumb mb-6 text-[var(--parchment-dim)]">
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="text-[0.65rem] font-bold tracking-widest text-[var(--primary)] border-l border-[rgba(201,165,92,0.3)] pl-2">
                {office.flag}
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-serif text-5xl sm:text-6xl lg:text-7xl text-[var(--parchment)] leading-[1] tracking-tight"
            >
              {office.city}
            </motion.h1>
            <motion.p
              ...
              className="mt-5 text-lg text-[var(--parchment-dim)] max-w-xl leading-relaxed"
            >
              {t(office.descKey)}
            </motion.p>
          </div>
      ...
      {/* Why this city */}
      <section className="py-20 sm:py-24 bg-[#0a1626]">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="max-w-2xl mb-12" data-reveal>
            <div className="section-tag mb-5">{t("office.whyTitle")} {office.city}</div>
            <h2 className="font-serif text-3xl sm:text-4xl text-[var(--parchment)] leading-tight">
              {t("office.whyTitle")}{" "}
          ...
          <div className="grid md:grid-cols-3 gap-5 sm:gap-6">
            {whyKeys.map((why, i) => (
              <div
                ...
                className="group relative p-7 sm:p-8 rounded-sm border border-[rgba(201,165,92,0.14)] bg-gradient-to-br from-[#0b1626] to-[#0a1626] hover:border-[var(--primary)]/45 transition-all duration-500"
              >
                <span className="absolute top-6 right-6 font-serif text-2xl text-[var(--primary)]/25">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <div className="w-14 h-14 rounded-sm border border-[rgba(201,165,92,0.3)] bg-[rgba(201,165,92,0.05)] flex items-center justify-center text-[var(--primary)] mb-6 transition-all duration-500 group-hover:bg-[var(--primary)] group-hover:text-[#0a1420]">
                  <why.Icon className="h-7 w-7" />
                </div>
                <h3 className="font-serif text-xl text-[var(--parchment)] mb-3">{why.t}</h3>
                <p className="text-sm text-[var(--parchment-dim)] leading-relaxed">{why.d}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div data-reveal>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl text-[var(--parchment)] mb-8">
                {office.legalName}
              </h2>

              <div className="space-y-6">
                <div className="flex items-start gap-4 p-5 rounded-sm border border-[rgba(201,165,92,0.14)] bg-[#0b1626]">
                  <div className="w-11 h-11 rounded-sm border border-[rgba(201,165,92,0.3)] bg-[rgba(201,165,92,0.05)] flex items-center justify-center text-[var(--primary)] flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--parchment)] leading-relaxed">{office.address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-sm border border-[rgba(201,165,92,0.14)] bg-[#0b1626]">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--parchment)]">{office.hours} ({office.hoursTz})</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-sm border border-[rgba(201,165,92,0.14)] bg-[#0b1626]">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--parchment)] hover:text-[var(--primary)] transition-colors break-all">
                      {CONTACT_EMAIL}
                    </a>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                {sectorCommodities.map((c) => c && (
                  <RLink
                    key={c.id}
                    to={`/commodities/${c.id}`}
                    className="group flex items-center gap-4 p-5 rounded-sm border border-[rgba(201,165,92,0.14)] bg-[#0b1626] hover:border-[var(--primary)]/45 transition-colors duration-500"
                  >
                    <div className="w-14 h-14 rounded-sm overflow-hidden flex-shrink-0 border border-[rgba(201,165,92,0.2)]">
                      <img src={c.image} alt={c.name} className="w-full h-full object-cover" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <c.icon className="h-4 w-4 text-[var(--primary)]" />
                        <h3 className="font-serif text-lg text-[var(--parchment)] group-hover:text-[var(--primary)] transition-colors">
                          {c.name}
                        </h3>
                      </div>
                      <p className="text-xs text-[var(--parchment-dim)] mt-1 line-clamp-1">
